      ...
      <section className="relative py-20 bg-gradient-to-br from-red-600 via-red-700 to-yellow-500 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            >
              <a
                href="https://wa.me/5493855854741?text=Hola!%20Quiero%20consultar%20por%20aceites%20Shell%20Helix"
                target="_blank"
                  ...
                  <div className="p-6 lg:p-8">
                    <div className="flex flex-col lg:flex-row gap-6">
                      ...
                      <div className="lg:w-64 flex flex-col justify-center gap-3">
                        ...
                        <a
                          href={`https://wa.me/5493855854741?text=Hola!%20Quiero%20consultar%20por%20${encodeURIComponent(oil.name)}%20${oil.viscosity}`}
                          target="_blank"
                          rel="noopener noreferrer"
