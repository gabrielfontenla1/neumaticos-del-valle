      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="relative flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            {/* Results Header */}
            <div className="bg-[#FFFFFF] p-3 rounded-lg border border-gray-200 mb-4">
            ...
            <div className="bg-[#FFFFFF] rounded-lg border border-gray-300 shadow-md p-6 mb-6">
              <div className="mb-4">
                <h3 className="text-lg font-bold text-gray-900 mb-2">Buscar por medida de neumático</h3>
                <p className="text-sm text-gray-600">Seleccioná las medidas exactas que necesitás para tu vehículo</p>
              </div>
              ...
              {(selectedWidth !== 'all' || selectedProfile !== 'all' || selectedDiameter !== 'all') && (
                <div className="mt-4 pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-gray-600">Medida seleccionada:</span>
                    ...
                    <Button
                      ...
                      variant="link"
                      size="sm"
                      className="h-auto px-0 text-sm text-blue-600 hover:text-blue-700 font-medium"
                    >
            ...
            {filteredProducts.length === 0 ? (
              ...
              <>
                          ...
                          <div className="flex-1 flex flex-col p-4">
                            ...
                            <div className="h-20 flex flex-col justify-between">
                              ...
                              <div className="flex items-center justify-between gap-2 h-7">
                                <Link href={`/productos/${product.id}`} className="flex-shrink min-w-0">
                ...
                {/* Pagination */}
                {totalPages > 1 && (
                  <div className="mt-8 bg-[#FFFFFF] p-4 rounded-lg border border-gray-200">
