export default function AgroCamionesSkeleton() {
  return (
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="relative flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            {/* Size filter section skeleton */}
            <div className="bg-white rounded-lg border border-gray-300 shadow-md p-3 sm:p-5 mb-6">
